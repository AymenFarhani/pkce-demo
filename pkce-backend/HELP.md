...
* The original package name 'com.pkce-bff' is invalid and this project uses 'com.pkce_bff' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.5.15/reference/web/spring-security.html#web.security.oauth2.server)
